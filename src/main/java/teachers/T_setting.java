...
/**
 * Servlet implementation class T_setting
 */
@WebServlet("/T_setting")
public class T_setting extends HttpServlet {
		...
		try {
			Class.forName("com.mysql.jdbc.Driver");
			 Connection con=DriverManager.getConnection("jdbc:mysql://root:_zq27kd-0f5w8g3qfucei-u$pph1onfx@monorail.proxy.rlwy.net:26454/railway","root","_zq27kd-0f5w8g3qfucei-u$pph1onfx");
			   ...
			   ResultSet rs=stmt.executeQuery("select * from staff where t_id='"+id+"'");
			   while(rs.next())
			   {
				   out.println("<!DOCTYPE html>\r\n"
				   		...
				   		+ "                <h4 style=\"width: 164px;\">Hello "+rs.getString("t_name")+"</h4>\r\n"
				   		...
				   		+ "                \r\n"
				   		+ " 				 <form action=\"T_set\" method=\"post\">"
				   		+ "                  <div class=\"form-group\">\r\n"
				   		+ "                  <div class=\"form-group\">\r\n"
				   		+ "                    <label for=\"email\"> Enter Password:</label>\r\n"
				   		+ "                    <input type=\"text\" id=\"email\" name=\"pass\"  value=\""+rs.getString("t_pass")+"\" required>\r\n"
				   		+ "                  </div>\r\n"
				   		+ "                  <div class=\"form-group\">\r\n"
				   		+ "                    <label for=\"password\">Re Enter password:</label>\r\n"
				   		+ "                    <input type=\"text\" id=\"phone\" name=\"pass1\" value=\""+rs.getString("t_pass")+"\" required>\r\n"
				   		+ "                  </div>\r\n"
				   		+ "                \r\n"
				   		+ "                  <div class=\"form-group\">\r\n"
